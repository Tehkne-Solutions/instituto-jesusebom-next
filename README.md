...
A página `/doacao` foi refinada para seguir melhor o protótipo enviado pelo Rubens:

- form inicial limpo;
- dados do doador em segunda etapa;
- vídeo à direita preenchendo a altura visual da hero;
- título em três linhas no desktop;
