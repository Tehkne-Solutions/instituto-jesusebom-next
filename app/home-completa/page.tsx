...
export const metadata = {
  title: "Home Completa — Instituto Jesus é Bom",
  description:
    "Versão completa da homepage do Instituto Jesus é Bom unindo impacto, missão, formação integral, transparência, doações, projetos e visão da escola cristã integral."
};
      ...
      <main>
        <section className="heroFull">
          ...
          <div className="container heroFullInner">
            ...
            <FadeIn className="heroPanel heroFullPanel" delay={0.18} y={26}>
              ...
              <p>Uma atuação real com educação, acolhimento, desenvolvimento social e formação cristã.</p>
            </FadeIn>
          </div>
        </section>
